 ...
 * reduced.
 * 
 * Invariant: We never run into a state where the binary operator is not null,
 * while the first operand is empty. Likewise, we cannot have the first operand
 * or binary operator empty while the second operand being non-empty.
 */
